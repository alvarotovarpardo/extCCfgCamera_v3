...
private:
    ...
    int m_iLeftCutout, m_iRightCutout, m_iTopCutout, m_iBottomCutout,m_iFocalLength,m_iPixelPitch;
    ...
    bool m_bVerticalFlip, m_bHorizontalFlip, m_bImageRotate, m_bPaletteBar, m_bStretching, m_bAutoStretching, m_bStretchingRegion, m_bShowROI, m_bShowNOROI, m_bShowDigitalLevels, m_bShowSaturatedPixels;
    int m_iRegionSize;
    ...
    bool m_bAutomaticRaw, m_bAutomaticMP4;
    ...
    /* Preset limits */
    int m_iPTLimitTiltTop, m_iPTLimitTiltBottom, m_iPTLimitPanLeft, m_iPTLimitPanRight;
};
